...
"""autogenerated by genpy from turtlebot_transport_flexmansys/TransportUnitState.msg. Do not edit."""
import codecs
import sys
...
import turtlebot_transport_flexmansys.msg

class TransportUnitState(genpy.Message):
  _md5sum = "4a9f169d9b464fbeb767cabba27149f7"
  _type = "turtlebot_transport_flexmansys/TransportUnitState"
...
"""
  ...
  _slot_types = ['turtlebot_transport_flexmansys/KobukiGeneral','turtlebot_transport_flexmansys/KobukiObstacle','turtlebot_transport_flexmansys/KobukiPosition','turtlebot_transport_flexmansys/TimeDate']
  ...
  def __init__(self, *args, **kwds):
    ...
    if args or kwds:
      ...
      if self.kobuki_general is None:
        self.kobuki_general = turtlebot_transport_flexmansys.msg.KobukiGeneral()
      if self.kobuki_obstacle is None:
        self.kobuki_obstacle = turtlebot_transport_flexmansys.msg.KobukiObstacle()
      if self.kobuki_position is None:
        self.kobuki_position = turtlebot_transport_flexmansys.msg.KobukiPosition()
      if self.odroid_date is None:
        self.odroid_date = turtlebot_transport_flexmansys.msg.TimeDate()
    else:
      self.kobuki_general = turtlebot_transport_flexmansys.msg.KobukiGeneral()
      self.kobuki_obstacle = turtlebot_transport_flexmansys.msg.KobukiObstacle()
      self.kobuki_position = turtlebot_transport_flexmansys.msg.KobukiPosition()
