...
(cl:defmethod cl:initialize-instance :after ((m <KobukiGeneral>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KobukiGeneral)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name custom_messages-msg:<KobukiGeneral> is deprecated: use custom_messages-msg:KobukiGeneral instead.")))

(cl:ensure-generic-function 'transport_unit_name-val :lambda-list '(m))
(cl:defmethod transport_unit_name-val ((m <KobukiGeneral>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:transport_unit_name-val is deprecated.  Use custom_messages-msg:transport_unit_name instead.")
...
(cl:defmethod transport_unit_state-val ((m <KobukiGeneral>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:transport_unit_state-val is deprecated.  Use custom_messages-msg:transport_unit_state instead.")
  (transport_unit_state m))

(cl:ensure-generic-function 'battery-val :lambda-list '(m))
(cl:defmethod battery-val ((m <KobukiGeneral>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader custom_messages-msg:battery-val is deprecated.  Use custom_messages-msg:battery instead.")
  (battery m))
