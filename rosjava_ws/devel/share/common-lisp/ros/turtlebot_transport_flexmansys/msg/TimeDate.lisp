...
(cl:defmethod cl:initialize-instance :after ((m <TimeDate>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TimeDate)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_transport_flexmansys-msg:<TimeDate> is deprecated: use turtlebot_transport_flexmansys-msg:TimeDate instead.")))

(cl:ensure-generic-function 'year-val :lambda-list '(m))
(cl:defmethod year-val ((m <TimeDate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:year-val is deprecated.  Use turtlebot_transport_flexmansys-msg:year instead.")
  (year m))

(cl:ensure-generic-function 'month-val :lambda-list '(m))
(cl:defmethod month-val ((m <TimeDate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:month-val is deprecated.  Use turtlebot_transport_flexmansys-msg:month instead.")
  (month m))

(cl:ensure-generic-function 'day-val :lambda-list '(m))
(cl:defmethod day-val ((m <TimeDate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:day-val is deprecated.  Use turtlebot_transport_flexmansys-msg:day instead.")
  (day m))

(cl:ensure-generic-function 'hour-val :lambda-list '(m))
(cl:defmethod hour-val ((m <TimeDate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:hour-val is deprecated.  Use turtlebot_transport_flexmansys-msg:hour instead.")
  (hour m))

(cl:ensure-generic-function 'minute-val :lambda-list '(m))
(cl:defmethod minute-val ((m <TimeDate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:minute-val is deprecated.  Use turtlebot_transport_flexmansys-msg:minute instead.")
  (minute m))

(cl:ensure-generic-function 'seconds-val :lambda-list '(m))
(cl:defmethod seconds-val ((m <TimeDate>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:seconds-val is deprecated.  Use turtlebot_transport_flexmansys-msg:seconds instead.")
  (seconds m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TimeDate>)))
  ...
  "turtlebot_transport_flexmansys/TimeDate")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TimeDate)))
  "Returns string type for a message object of type 'TimeDate"
  "turtlebot_transport_flexmansys/TimeDate")
