...
(cl:in-package nombre_paquete-msg)
...
(cl:defmethod cl:initialize-instance :after ((m <Prueba>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'Prueba)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name nombre_paquete-msg:<Prueba> is deprecated: use nombre_paquete-msg:Prueba instead.")))

(cl:ensure-generic-function 'numero_prueba-val :lambda-list '(m))
(cl:defmethod numero_prueba-val ((m <Prueba>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader nombre_paquete-msg:numero_prueba-val is deprecated.  Use nombre_paquete-msg:numero_prueba instead.")
  (numero_prueba m))
