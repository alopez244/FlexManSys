...
public class ListenerBorradorBorrador extends AbstractNodeMain {
  ...
  public void onStart(ConnectedNode connectedNode) {
    ...
    Subscriber<custom_messages.TransportUnitState> subscriber = connectedNode.newSubscriber("/borrador/prueba",
            custom_messages.TransportUnitState._TYPE);

    subscriber.addMessageListener(new MessageListener<custom_messages.TransportUnitState>() {

      @Override

      public void onNewMessage(custom_messages.TransportUnitState TransportMessage) {
        ...
        log.info("Nombre AGV: " + transport_unit_name + "\n" +
