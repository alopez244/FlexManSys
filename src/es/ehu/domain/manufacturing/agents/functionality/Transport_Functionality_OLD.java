...
import es.ehu.domain.manufacturing.agents.TransportAgent_OLD;
...
public class Transport_Functionality_OLD extends DomApp_Functionality implements BasicFunctionality, NegFunctionality, AssetManagement {
    ...
    static final Logger LOGGER = LogManager.getLogger(Transport_Functionality_OLD.class.getName());

    /** Identifier of the agent. */
    private TransportAgent_OLD myAgent;
    ...
    public Void init(MWAgent mwAgent) {
        ...
        this.myAgent = (TransportAgent_OLD) mwAgent;
        LOGGER.entry();
