...
//                    }
                    ...
                    String negotiationQuery = "localneg " + targets + " criterion=max mem action=start externaldata=" + elementID + "," + seCategory + "," + seClass + "," + ((i == Integer.parseInt(redundancy)-1) ? "running" : "tracking") + "," + redundancy + "," + myAgent.getLocalName();
