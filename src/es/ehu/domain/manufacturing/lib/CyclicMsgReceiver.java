 ...
 * 
 * Modificado para que los mensajes sean ciclicos, con un intervalo 
 * de tiempo (timeout)
 * 
 ...
 **/
public class CyclicMsgReceiver extends SimpleBehaviour {
	 ...
	 * @param timeout a timeout for waiting until a message arrives. It must
	 ...
	 **/
	public CyclicMsgReceiver(Agent a, MessageTemplate mt, long timeout, DataStore s, Object msgKey) {
		super(a);
		setDataStore(s);
		template = mt;
	...
	/**
       ...
       receive operation.
       @param timeout The relative timeout of the receive
