...
ODK_RESULT initAgent() {
	...
	if (!uniqueStart) {				//It only happens on the first run
		...
		jstring machineID = env->NewStringUTF("5");	//Se inicializa como agente gateway para la maquina 5 
...
bool JNIinit(void) {
	...
	//options[0].optionString = "-Djava.class.path=C:\\Users\\dgarcia129\\IdeaProjects\\FlexManSys\\classes;C:\\Users\\dgarcia129\\Documents\\Java\\Libraries\\jade-4.3.jar;C:\\Users\\dgarcia129\\Documents\\Java\\Libraries\\gson-2.8.6.jar;C:\\Users\\dgarcia129\\Documents\\Java\\Libraries\\commons-collections4-4.4.jar";
