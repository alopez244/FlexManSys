...
import rospy
import rospkg
from servicio_cuadrado.srv import MyCustomServiceMessage, MyCustomServiceMessageResponse
...
move_bb8_in_square_service_client = rospy.ServiceProxy('/move_bb8_in_square_custom', MyCustomServiceMessage)
# Create an object of type EmptyRequest
move_bb8_in_square_request_object = MyCustomServiceMessageResponse()
