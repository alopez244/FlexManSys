...
# Hay que ejecutar rosservice call/get_pose_service "{}"
# En una segunda terminal, de este modo, sabremos la posicion actual que esta
# Percibiendo el robot y el lugar exacto en el que se encuentra
