...
set(MSG_I_FLAGS "-Imy_package:/home/borjartime/catkin_ws/src/my_package/msg;-Istd_msgs:/opt/ros/kinetic/share/std_msgs/cmake/../msg")
...
get_filename_component(_filename "/home/borjartime/catkin_ws/src/my_package/msg/Age.msg" NAME_WE)
add_custom_target(_my_package_generate_messages_check_deps_${_filename}
  COMMAND ${CATKIN_ENV} ${PYTHON_EXECUTABLE} ${GENMSG_CHECK_DEPS_SCRIPT} "my_package" "/home/borjartime/catkin_ws/src/my_package/msg/Age.msg" ""
)
...
_generate_msg_cpp(my_package
  "/home/borjartime/catkin_ws/src/my_package/msg/Age.msg"
  "${MSG_I_FLAGS}"
  ""
...
### Generating Messages
_generate_msg_java(my_package
  "/home/borjartime/catkin_ws/src/my_package/msg/Age.msg"
  "${MSG_I_FLAGS}"
  ""
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/my_package
)

### Generating Services

### Generating Module File
_generate_module_java(my_package
  ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/my_package
  "${ALL_GEN_OUTPUT_FILES_java}"
)

add_custom_target(my_package_generate_messages_java
  DEPENDS ${ALL_GEN_OUTPUT_FILES_java}
)
add_dependencies(my_package_generate_messages my_package_generate_messages_java)

# add dependencies to all check dependencies targets
get_filename_component(_filename "/home/borjartime/catkin_ws/src/my_package/msg/Age.msg" NAME_WE)
add_dependencies(my_package_generate_messages_java _my_package_generate_messages_check_deps_${_filename})

# target for backward compatibility
add_custom_target(my_package_genjava)
add_dependencies(my_package_genjava my_package_generate_messages_java)

# register target for catkin_package(EXPORTED_TARGETS)
list(APPEND ${PROJECT_NAME}_EXPORTED_TARGETS my_package_generate_messages_java)
...
if(genjava_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/my_package)
  # install generated code
  install(
    DIRECTORY ${CATKIN_DEVEL_PREFIX}/${genjava_INSTALL_DIR}/my_package
    DESTINATION ${genjava_INSTALL_DIR}
  )
endif()
if(TARGET std_msgs_generate_messages_java)
  add_dependencies(my_package_generate_messages_java std_msgs_generate_messages_java)
endif()
...
if(genpy_INSTALL_DIR AND EXISTS ${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_package)
  install(CODE "execute_process(COMMAND \"/usr/bin/python2\" -m compileall \"${CATKIN_DEVEL_PREFIX}/${genpy_INSTALL_DIR}/my_package\")")
  # install generated code
  install(
