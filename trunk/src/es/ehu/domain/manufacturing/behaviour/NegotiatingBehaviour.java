...
public class NegotiatingBehaviour extends SimpleBehaviour {
  ...
  public NegotiatingBehaviour(MC_Agent a) {
    super(a);
    this.myAgent = a;
  }
  ...
  public void onStart() {
    LOGGER.entry();
    LOGGER.debug("***************** inicio NegotiatingBehaviour");
    transitionFlag = 0;
    nextActivation = 0;
    realActivation = 0;
    finished = false;
    template = MessageTemplate.MatchOntology("restart");
    activedIntace = "";
  ...
  public void action() {
    ...
    try {
      ...
      if (nextActivation - System.currentTimeMillis() <= 0) {
        ...
        // Comprovar si he recivido el mensaje que me dice que instancia deve de recuperarse
        if (activedIntace.equals("")) {
          ...
          if(myAgent.getLocalName().equals(activedIntace)){
            ...
            // Si tengo el mismo nombre que la instancia que me mandaron ir a runing y poner los demas a traking
            ...
            if(value.equals("0")){
              ...
              if (pausedIns.length() > 0) {
                ...
                myAgent.sendCommand("localcmd " + activedIntace + " cmd=setstate running");
      ...
      else if (nextActivation - System.currentTimeMillis() >= 0) { // es periódica pero no toca
                                                                   // activarse
        /**
