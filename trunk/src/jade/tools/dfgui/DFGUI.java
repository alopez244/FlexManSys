...
*/
    ...
    Icon regNewImg = DFGuiProperties.getIcon("registeragent");
		...
		c.setHeaderValue((Object) ("Agent names"));
		...
		c = registeredTable.getColumn((Object) registeredTable.getColumnName(3));
		c.setHeaderValue((Object) ("State"));
		...
		c = foundTable.getColumn(foundTable.getColumnName(3));
		c.setHeaderValue("States");
...
JPanel lastSearchPanel2 = new JPanel();
lastSearchPanel.setLayout(new BorderLayout());
foundModel = new AgentNameTableModel();
foundTable = new JTable(foundModel); 
foundTable.setRowHeight(20);
...
tabbedPane.addTab("Registered Applications",lastSearchPanel);	

JSplitPane tablePane2 = new JSplitPane(JSplitPane.VERTICAL_SPLIT);
tablePane.setContinuousLayout(true);
		...
		c.setHeaderValue("Resolvers");
		c = parentTable.getColumn(parentTable.getColumnName(3));
	  ...
	  // Column names
		...
		c.setHeaderValue("Resolvers");
		c = childrenTable.getColumn(childrenTable.getColumnName(3));
		c.setHeaderValue("State");
