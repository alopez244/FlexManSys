...
public class AID implements Comparable, Serializable {
	 ...
	 * @param guid is the Globally Unique identifier for the agent. The slot name
	...
	public AID(String name, boolean isGUID, String state) {
	...
	public synchronized Object clone() {
		AID result = new AID(this.name, ISGUID, this.state);
