...
(cl:defmethod cl:initialize-instance :after ((m <KobukiPosition>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'KobukiPosition)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_transport_flexmansys-msg:<KobukiPosition> is deprecated: use turtlebot_transport_flexmansys-msg:KobukiPosition instead.")))

(cl:ensure-generic-function 'transport_in_dock-val :lambda-list '(m))
(cl:defmethod transport_in_dock-val ((m <KobukiPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:transport_in_dock-val is deprecated.  Use turtlebot_transport_flexmansys-msg:transport_in_dock instead.")
  (transport_in_dock m))

(cl:ensure-generic-function 'recovery_point-val :lambda-list '(m))
(cl:defmethod recovery_point-val ((m <KobukiPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:recovery_point-val is deprecated.  Use turtlebot_transport_flexmansys-msg:recovery_point instead.")
  (recovery_point m))

(cl:ensure-generic-function 'odom_x-val :lambda-list '(m))
(cl:defmethod odom_x-val ((m <KobukiPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:odom_x-val is deprecated.  Use turtlebot_transport_flexmansys-msg:odom_x instead.")
  (odom_x m))

(cl:ensure-generic-function 'odom_y-val :lambda-list '(m))
(cl:defmethod odom_y-val ((m <KobukiPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:odom_y-val is deprecated.  Use turtlebot_transport_flexmansys-msg:odom_y instead.")
  (odom_y m))

(cl:ensure-generic-function 'rotation-val :lambda-list '(m))
(cl:defmethod rotation-val ((m <KobukiPosition>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:rotation-val is deprecated.  Use turtlebot_transport_flexmansys-msg:rotation instead.")
  (rotation m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<KobukiPosition>)))
  ...
  "turtlebot_transport_flexmansys/KobukiPosition")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'KobukiPosition)))
  "Returns string type for a message object of type 'KobukiPosition"
  "turtlebot_transport_flexmansys/KobukiPosition")
