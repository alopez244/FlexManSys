...
(cl:defclass <TransportUnitState> (roslisp-msg-protocol:ros-message)
  ((kobuki_general
    ...
    :type turtlebot_transport_flexmansys-msg:KobukiGeneral
    :initform (cl:make-instance 'turtlebot_transport_flexmansys-msg:KobukiGeneral))
   (kobuki_obstacle
    :reader kobuki_obstacle
    :initarg :kobuki_obstacle
    :type turtlebot_transport_flexmansys-msg:KobukiObstacle
    :initform (cl:make-instance 'turtlebot_transport_flexmansys-msg:KobukiObstacle))
   (kobuki_position
    :reader kobuki_position
    :initarg :kobuki_position
    :type turtlebot_transport_flexmansys-msg:KobukiPosition
    :initform (cl:make-instance 'turtlebot_transport_flexmansys-msg:KobukiPosition))
   (odroid_date
    :reader odroid_date
    :initarg :odroid_date
    :type turtlebot_transport_flexmansys-msg:TimeDate
    :initform (cl:make-instance 'turtlebot_transport_flexmansys-msg:TimeDate)))
)
...
(cl:defmethod cl:initialize-instance :after ((m <TransportUnitState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransportUnitState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_transport_flexmansys-msg:<TransportUnitState> is deprecated: use turtlebot_transport_flexmansys-msg:TransportUnitState instead.")))

(cl:ensure-generic-function 'kobuki_general-val :lambda-list '(m))
(cl:defmethod kobuki_general-val ((m <TransportUnitState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:kobuki_general-val is deprecated.  Use turtlebot_transport_flexmansys-msg:kobuki_general instead.")
  (kobuki_general m))

(cl:ensure-generic-function 'kobuki_obstacle-val :lambda-list '(m))
(cl:defmethod kobuki_obstacle-val ((m <TransportUnitState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:kobuki_obstacle-val is deprecated.  Use turtlebot_transport_flexmansys-msg:kobuki_obstacle instead.")
  (kobuki_obstacle m))

(cl:ensure-generic-function 'kobuki_position-val :lambda-list '(m))
(cl:defmethod kobuki_position-val ((m <TransportUnitState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:kobuki_position-val is deprecated.  Use turtlebot_transport_flexmansys-msg:kobuki_position instead.")
  (kobuki_position m))

(cl:ensure-generic-function 'odroid_date-val :lambda-list '(m))
(cl:defmethod odroid_date-val ((m <TransportUnitState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:odroid_date-val is deprecated.  Use turtlebot_transport_flexmansys-msg:odroid_date instead.")
  (odroid_date m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransportUnitState>)))
  ...
  "turtlebot_transport_flexmansys/TransportUnitState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransportUnitState)))
  "Returns string type for a message object of type 'TransportUnitState"
  "turtlebot_transport_flexmansys/TransportUnitState")
...
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql '<TransportUnitState>)))
  ...
  (cl:format cl:nil "KobukiGeneral kobuki_general~%KobukiObstacle kobuki_obstacle~%KobukiPosition kobuki_position~%TimeDate odroid_date~%~%~%================================================================================~%MSG: turtlebot_transport_flexmansys/KobukiGeneral~%string transport_unit_name~%string transport_unit_state~%float32 battery~%================================================================================~%MSG: turtlebot_transport_flexmansys/KobukiObstacle~%bool detected_obstacle_bumper~%bool detected_obstacle_camera~%================================================================================~%MSG: turtlebot_transport_flexmansys/KobukiPosition~%bool transport_in_dock~%string recovery_point~%float64 odom_x~%float64 odom_y~%float64 rotation~%================================================================================~%MSG: turtlebot_transport_flexmansys/TimeDate~%int32 year~%int32 month~%int32 day~%int32 hour~%int32 minute~%int32 seconds~%~%~%~%"))
(cl:defmethod roslisp-msg-protocol:message-definition ((type (cl:eql 'TransportUnitState)))
  "Returns full string definition for message of type 'TransportUnitState"
  (cl:format cl:nil "KobukiGeneral kobuki_general~%KobukiObstacle kobuki_obstacle~%KobukiPosition kobuki_position~%TimeDate odroid_date~%~%~%================================================================================~%MSG: turtlebot_transport_flexmansys/KobukiGeneral~%string transport_unit_name~%string transport_unit_state~%float32 battery~%================================================================================~%MSG: turtlebot_transport_flexmansys/KobukiObstacle~%bool detected_obstacle_bumper~%bool detected_obstacle_camera~%================================================================================~%MSG: turtlebot_transport_flexmansys/KobukiPosition~%bool transport_in_dock~%string recovery_point~%float64 odom_x~%float64 odom_y~%float64 rotation~%================================================================================~%MSG: turtlebot_transport_flexmansys/TimeDate~%int32 year~%int32 month~%int32 day~%int32 hour~%int32 minute~%int32 seconds~%~%~%~%"))
