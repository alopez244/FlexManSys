...
(cl:defmethod cl:initialize-instance :after ((m <TransportPrivateState>) cl:&rest args)
  ...
  (cl:unless (cl:typep m 'TransportPrivateState)
    (roslisp-msg-protocol:msg-deprecation-warning "using old message class name turtlebot_transport_flexmansys-msg:<TransportPrivateState> is deprecated: use turtlebot_transport_flexmansys-msg:TransportPrivateState instead.")))

(cl:ensure-generic-function 'transport_state-val :lambda-list '(m))
(cl:defmethod transport_state-val ((m <TransportPrivateState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:transport_state-val is deprecated.  Use turtlebot_transport_flexmansys-msg:transport_state instead.")
  (transport_state m))

(cl:ensure-generic-function 'transport_docked-val :lambda-list '(m))
(cl:defmethod transport_docked-val ((m <TransportPrivateState>))
  (roslisp-msg-protocol:msg-deprecation-warning "Using old-style slot reader turtlebot_transport_flexmansys-msg:transport_docked-val is deprecated.  Use turtlebot_transport_flexmansys-msg:transport_docked instead.")
  (transport_docked m))
...
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql '<TransportPrivateState>)))
  ...
  "turtlebot_transport_flexmansys/TransportPrivateState")
(cl:defmethod roslisp-msg-protocol:ros-datatype ((msg (cl:eql 'TransportPrivateState)))
  "Returns string type for a message object of type 'TransportPrivateState"
  "turtlebot_transport_flexmansys/TransportPrivateState")
